Objectif : 
L'objectif de cet exercice est de cibler des éléments HTML dans un certain état en se basant sur les pseudo classes CSS : 
first-child, nth-child(), last-child, link, visited, hover ...
